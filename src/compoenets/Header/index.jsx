    ...
    <li>
      <ul className="welcome">
        ...
        <li>
          <pre>
            <i className="grey">
              Last login: {date.toLocaleDateString("en-US")},{" "}
              {date.toLocaleTimeString("en-US", { hour12: true })} GMT
              {gmtOffsetMinutes > 0 ? "-" : "+"}
              {gmtOffsetHours.toString().padStart(2, "0")}:
              {gmtOffsetMinutesRemainder.toString().padStart(2, "0")}{" "}
              {os && `on ${os}`}
            </i>
          </pre>
        </li>
        ...
        <li>
          <pre>
            <i className="greetings">{"{{ greetings }}"}</i>{" "}
          </pre>
        </li>
        <li>
          <pre> </pre>
        ...
        <li>
          <pre>
            I'm <i className="host">Ritwik Raj Singh</i>, a software engineer
            {/*<i className="blue">/</i>*/}
          </pre>
        </li>
        <li>
        ...
        <li>
          <pre>
            Type <i className="yellow command">`help`</i> to get a list of
            commands
          </pre>
        </li>
        <li>
